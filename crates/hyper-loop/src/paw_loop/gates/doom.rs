...
mod tests {
    ...
    #[test]
    fn sixth_repeat_warns_later_repeats_stay_silent() {
        ...
        match hop(&gate, 6, &[a.clone()]) {
            ...
            other => panic!("expected warn at 6th repeat: {other:?}"),
        }
        for iter in 7..=10 {
            assert!(matches!(
    ...
    #[test]
    fn bash_repeat_warns_at_six_and_does_not_halt() {
        let gate = DoomLoopGate::qwen_default();
