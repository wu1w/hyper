    ...
    H: ChannelHandler,
{
    ...
    tokio::select! {
        _ = tokio::signal::ctrl_c() => {
            eprintln!("hyper channels: stopping");
        }
        _ = async {
            for j in joins {
                let _ = j.await;
