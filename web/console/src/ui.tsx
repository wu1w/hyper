...
import { downloadHref, nameFromSrc } from "./media";
...
const PATHS: Record<string, string> = {
  ...
  image: "M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2zM8.5 10a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM21 15l-5-5-4 4-2-2-6 6",
...
/** Grok Imagine mark: split event horizon + photon ring. */
export function HoleMark({ label = "Hyper" }: { label?: string }) {
  return (
    <span className="hole-mark" role="img" aria-label={label}>
    ...
    <Overlay onClose={onClose}>
      ...
      >
        ...
        <div className="lightbox-bar">
          <a className="btn ghost small" href={href} download={name}>
            下载
          </a>
